...
# 4️⃣ Global SHAP Force Plot for Average Profile (mean of shap values)
...
# Optionally, add SHAP dependence plots for top features
top_features = X.columns[:3]  # example: first 3 features
